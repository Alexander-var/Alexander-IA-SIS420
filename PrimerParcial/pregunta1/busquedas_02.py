...
class ProblemaBusqueda(object):
    ...
    Para utilizar esta clase se debe implementar metodos requeridos por el algoritmo de busqueda
    que se utilizara.'''
...
def aestrella(problema, busqueda_en_grafo=False, viewer=None) -> object:
    '''
    Busuqeda A*.
