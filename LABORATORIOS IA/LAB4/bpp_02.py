...
def busqueda_BPPR(nodo_inicial, solucion, visitado):
    ...
    if nodo_inicial.get_estado() == solucion:
        ...
        hijo = [datos_nodo[1], datos_nodo[0], datos_nodo[2], datos_nodo[3],datos_nodo[6], datos_nodo[5],datos_nodo[4]]
        hijo_izquierda = Nodo(hijo)

        hijo = [datos_nodo[0], datos_nodo[2], datos_nodo[1], datos_nodo[3],datos_nodo[4], datos_nodo[6],datos_nodo[5]]
        hijo_centro = Nodo(hijo)

        hijo = [datos_nodo[0], datos_nodo[1], datos_nodo[3], datos_nodo[2],datos_nodo[4], datos_nodo[5],datos_nodo[6]]
        hijo_derecha = Nodo(hijo)

        hijo = [datos_nodo[0], datos_nodo[1], datos_nodo[3], datos_nodo[2],datos_nodo[5], datos_nodo[4],datos_nodo[6]]
        hijo_de = Nodo(hijo)
